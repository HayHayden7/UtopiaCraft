...
public class HerobrineForestBiome extends UtopiacraftModElements.ModElement {
	public static Biome biome;
	public HerobrineForestBiome(UtopiacraftModElements instance) {
		super(instance, 235);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("utopiacraft:herobrine_forest"));
			}
		}
	}
	@Override
