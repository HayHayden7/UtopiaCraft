...
public class HeavenlyForestBiome extends UtopiacraftModElements.ModElement {
	public static Biome biome;
	public HeavenlyForestBiome(UtopiacraftModElements instance) {
		super(instance, 207);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(HeavenwoodLogBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("utopiacraft:heavenly_forest"));
			}
		}
	}
	@Override
