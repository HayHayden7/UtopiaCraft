...
public class HeavenlyHillsBiome extends UtopiacraftModElements.ModElement {
	public static Biome biome;
	public HeavenlyHillsBiome(UtopiacraftModElements instance) {
		super(instance, 233);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.EXTREME_HILLS).depth(0.3f).scale(0.6f)
						.temperature(0.5f).downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("utopiacraft:heavenly_hills"));
			}
		}
	}
	@Override
