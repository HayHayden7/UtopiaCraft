...
public class ShavedForestBiome extends UtopiacraftModElements.ModElement {
	public static Biome biome;
	public ShavedForestBiome(UtopiacraftModElements instance) {
		super(instance, 243);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("utopiacraft:shaved_forest"));
			}
		}
	}
	@Override
