...
public class UtopianDesertBiome extends UtopiacraftModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16407587).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-16407587).withFoliageColor(10387789).withGrassColor(9470285).build();
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.DESERT).depth(0.1f).scale(0.1f).temperature(2f)
