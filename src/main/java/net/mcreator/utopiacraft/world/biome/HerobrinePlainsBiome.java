...
public class HerobrinePlainsBiome extends UtopiacraftModElements.ModElement {
	public static Biome biome;
	public HerobrinePlainsBiome(UtopiacraftModElements instance) {
		super(instance, 242);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-11747784).withGrassColor(-7354527).build();
				...
				event.getRegistry().register(biome.setRegistryName("utopiacraft:herobrine_plains"));
			}
		}
	}
	@Override
