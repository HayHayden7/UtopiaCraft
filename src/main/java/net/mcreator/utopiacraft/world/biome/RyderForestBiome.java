...
public class RyderForestBiome extends UtopiacraftModElements.ModElement {
	public static Biome biome;
	public RyderForestBiome(UtopiacraftModElements instance) {
		super(instance, 187);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-26164).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-26164).withFoliageColor(-39220).withGrassColor(-26113)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.HEART, 0.001f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.GRASS_BLOCK.getDefaultState(),
								Blocks.DIRT.getDefaultState(), Blocks.DIRT.getDefaultState())));
				biomeGenerationSettings.withStructure(StructureFeatures.MINESHAFT);
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(RyderLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(RyderLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("utopiacraft:ryder_forest"));
			}
		}
	}
	@Override
