...
public class UtopianForestBiome extends UtopiacraftModElements.ModElement {
	public static Biome biome;
	public UtopianForestBiome(UtopiacraftModElements instance) {
		super(instance, 11);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6684673).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-6684673).withFoliageColor(-6684775).withGrassColor(-6684775)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.FIREWORK, 0.001f)).build();
				...
				event.getRegistry().register(biome.setRegistryName("utopiacraft:utopian_forest"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("utopian_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("utopian_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("utopian_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
