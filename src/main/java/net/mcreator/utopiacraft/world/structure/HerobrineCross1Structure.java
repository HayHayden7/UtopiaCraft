...
public class HerobrineCross1Structure extends UtopiacraftModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public HerobrineCross1Structure(UtopiacraftModElements instance) {
		super(instance, 240);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 10000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("utopiacraft", "herobrine_cross_1"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("herobrine_cross_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("utopiacraft:herobrine_cross_1"), configuredFeature);
		}
	}
	@SubscribeEvent
