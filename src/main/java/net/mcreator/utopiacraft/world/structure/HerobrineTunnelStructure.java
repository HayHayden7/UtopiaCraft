...
public class HerobrineTunnelStructure extends UtopiacraftModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public HerobrineTunnelStructure(UtopiacraftModElements instance) {
		super(instance, 238);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 300000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("utopiacraft", "herobrine_tunnel"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("herobrine_tunnel"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("utopiacraft:herobrine_tunnel"), configuredFeature);
		}
	}
	@SubscribeEvent
