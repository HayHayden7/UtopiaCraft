...
public class HerobrinePyramid1Structure extends UtopiacraftModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("herobrine_pyramid_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("utopiacraft:herobrine_pyramid_1"), configuredFeature);
		}
	}
	@SubscribeEvent
