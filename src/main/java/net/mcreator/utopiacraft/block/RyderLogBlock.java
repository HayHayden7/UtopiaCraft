...
public class RyderLogBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:ryderlog")
	public static final Block block = null;
	public RyderLogBlock(UtopiacraftModElements instance) {
		super(instance, 10);
	}
