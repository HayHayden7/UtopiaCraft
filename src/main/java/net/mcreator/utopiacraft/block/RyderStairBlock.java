...
public class RyderStairBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:ryderstair")
	public static final Block block = null;
	public RyderStairBlock(UtopiacraftModElements instance) {
		super(instance, 16);
	}
