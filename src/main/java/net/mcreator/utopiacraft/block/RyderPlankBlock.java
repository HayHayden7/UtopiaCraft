...
public class RyderPlankBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:ryderplank")
	public static final Block block = null;
	public RyderPlankBlock(UtopiacraftModElements instance) {
		super(instance, 12);
	}
