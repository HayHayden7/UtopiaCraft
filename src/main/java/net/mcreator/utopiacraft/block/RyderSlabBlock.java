...
public class RyderSlabBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:ryderslab")
	public static final Block block = null;
	public RyderSlabBlock(UtopiacraftModElements instance) {
		super(instance, 19);
	}
