...
public class HeavenwoodStairsBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:heavenwood_stairs")
	public static final Block block = null;
	public HeavenwoodStairsBlock(UtopiacraftModElements instance) {
		super(instance, 208);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("heavenwood_stairs");
		}
