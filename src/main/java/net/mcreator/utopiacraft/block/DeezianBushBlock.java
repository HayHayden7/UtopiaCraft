...
import net.mcreator.utopiacraft.item.DeezianNutItem;
...
public class DeezianBushBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:deezianbush")
	public static final Block block = null;
	public DeezianBushBlock(UtopiacraftModElements instance) {
		super(instance, 77);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("deezianbush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("utopiacraft:deezianbush"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DeezianNutItem.block, (int) (1)));
		}
