...
public class RyderFenceGateBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:ryder_fence_gate")
	public static final Block block = null;
	public RyderFenceGateBlock(UtopiacraftModElements instance) {
		super(instance, 211);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ryder_fence_gate");
		}
