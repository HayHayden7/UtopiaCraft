...
public class HeavenwoodLogBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:heavenwood_log")
	public static final Block block = null;
	public HeavenwoodLogBlock(UtopiacraftModElements instance) {
		super(instance, 205);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("heavenwood_log");
		}
