...
public class AugmentedIronBlockBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:augmentedironblock")
	public static final Block block = null;
	public AugmentedIronBlockBlock(UtopiacraftModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("augmentedironblock");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used to create a portal to the Utopia"));
			list.add(new StringTextComponent("Ignite portal with Lint and Flint"));
		}
