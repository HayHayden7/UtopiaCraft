...
public class HeavenwoodFenceBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:heavenwood_fence")
	public static final Block block = null;
	public HeavenwoodFenceBlock(UtopiacraftModElements instance) {
		super(instance, 210);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("heavenwood_fence");
		}
