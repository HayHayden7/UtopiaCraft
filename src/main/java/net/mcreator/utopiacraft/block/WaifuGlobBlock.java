...
public class WaifuGlobBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:waifuglob")
	public static final Block block = null;
	public WaifuGlobBlock(UtopiacraftModElements instance) {
		super(instance, 160);
	}
