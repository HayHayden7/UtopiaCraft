...
public class HeavenwoodFenceGateBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:heavenwood_fence_gate")
	public static final Block block = null;
	public HeavenwoodFenceGateBlock(UtopiacraftModElements instance) {
		super(instance, 212);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("heavenwood_fence_gate");
		}
