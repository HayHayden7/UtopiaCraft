...
public class BunkOreBlock extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:bunkore")
	public static final Block block = null;
	public BunkOreBlock(UtopiacraftModElements instance) {
		super(instance, 48);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("utopiacraft:bunkore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("bunkore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("utopiacraft:bunkore"), configuredFeature);
		}
	}
	@SubscribeEvent
