...
public class WaifuCard7Item extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:waifucard7")
	public static final Item block = null;
	public WaifuCard7Item(UtopiacraftModElements instance) {
		super(instance, 130);
	}
