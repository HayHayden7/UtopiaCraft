...
public class LintisiumIngotItem extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:lintisiumingot")
	public static final Item block = null;
	public LintisiumIngotItem(UtopiacraftModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lintisiumingot");
		}
