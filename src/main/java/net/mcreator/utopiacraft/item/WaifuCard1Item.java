...
public class WaifuCard1Item extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:waifucard1")
	public static final Item block = null;
	public WaifuCard1Item(UtopiacraftModElements instance) {
		super(instance, 124);
	}
