...
public class WaifuCard3Item extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:waifucard3")
	public static final Item block = null;
	public WaifuCard3Item(UtopiacraftModElements instance) {
		super(instance, 126);
	}
