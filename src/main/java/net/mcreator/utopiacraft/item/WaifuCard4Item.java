...
public class WaifuCard4Item extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:waifucard4")
	public static final Item block = null;
	public WaifuCard4Item(UtopiacraftModElements instance) {
		super(instance, 127);
	}
