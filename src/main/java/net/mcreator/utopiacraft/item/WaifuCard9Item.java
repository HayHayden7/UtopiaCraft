...
public class WaifuCard9Item extends UtopiacraftModElements.ModElement {
	@ObjectHolder("utopiacraft:waifucard9")
	public static final Item block = null;
	public WaifuCard9Item(UtopiacraftModElements instance) {
		super(instance, 132);
	}
